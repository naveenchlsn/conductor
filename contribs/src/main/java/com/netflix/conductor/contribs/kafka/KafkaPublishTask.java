...
public class KafkaPublishTask extends WorkflowSystemTask {
	...
	private static final String REQUEST_PARAMETER_NAME = "kafka_request";
	...
	private static final String MISSING_KAFKA_BODY = "Missing Kafka body.  See documentation for KafkaTask for required input parameters";
	...
	public void start(Workflow workflow, Task task, WorkflowExecutor executor) {
		...
		if (Objects.isNull(input.getValue())) {
			markTaskAsFailed(task, MISSING_KAFKA_BODY);
			return;
		}
